...
from src.calculations_arrays import Calculations
from src.output_app import ResultWindow
from src.fridman_calculations_array import fridman_calculations_
from utils.error_text_maker import define_error_text
